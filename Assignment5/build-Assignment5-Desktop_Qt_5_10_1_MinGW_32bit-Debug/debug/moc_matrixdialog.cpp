...
#include "../../Assignment5/matrixdialog.h"
...
void MatrixDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MatrixDialog::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MatrixDialog::addMatrix)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MatrixDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MatrixDialog.data,
      qt_meta_data_MatrixDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *MatrixDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MatrixDialog.stringdata0))
