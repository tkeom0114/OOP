...
#include "../../Assignment5/editdialog.h"
...
QT_MOC_LITERAL(1, 11, 9), // "editValue"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 17), // "on_pushOK_clicked"
QT_MOC_LITERAL(4, 40, 11) // "changeLabel"

    },
    "EditDialog\0editValue\0\0on_pushOK_clicked\0"
    "changeLabel"
};
...
void EditDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditDialog::editValue)) {
                *result = 0;
                return;
            }
        }
