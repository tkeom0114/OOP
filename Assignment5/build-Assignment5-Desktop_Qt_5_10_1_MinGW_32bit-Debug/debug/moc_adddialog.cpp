...
#include "../../Assignment5/adddialog.h"
...
QT_MOC_LITERAL(1, 10, 12), // "addOperation"
...
QT_MOC_LITERAL(5, 57, 12) // "changeLabel2"
    ...
    "AddDialog\0addOperation\0\0on_pushOK_2_clicked\0"
...
void AddDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddDialog::addOperation)) {
                *result = 0;
                return;
            }
        }
