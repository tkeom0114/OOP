...
#include "../../Assignment5/deletedialog.h"
...
QT_MOC_LITERAL(1, 13, 11), // "deleteValue"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 17), // "on_pushOK_clicked"
QT_MOC_LITERAL(4, 44, 11) // "changeLabel"

    },
    "DeleteDialog\0deleteValue\0\0on_pushOK_clicked\0"
    "changeLabel"
};
...
void DeleteDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->deleteValue(); break;
        case 1: _t->on_pushOK_clicked(); break;
        case 2: _t->changeLabel((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (DeleteDialog::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DeleteDialog::deleteValue)) {
                *result = 0;
                return;
            }
        }
